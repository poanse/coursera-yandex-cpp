...
int main() {
	...
	shared_ptr<Node> mul1 = 
		make_shared<Operation>('*', var1, var2);
	...
	shared_ptr<Node> plus1 = 
		make_shared<Operation>('+', dig1, dig2);

	shared_ptr<Node> minus1 = 
		make_shared<Operation>('-', plus1, mul1);
